...
mapS_byCCAA <- function(map, provincias) {
  #' Subset a spatial map by Community of Autonomous Region (CCAA)
  #'
  #' This function subsets a given spatial map based on the specified Community of Autonomous Region (CCAA).
  #'
  #' @param map A spatial map to be subset.
  #' @param provincias A character vector containing the name of the CCAA for subset
  #'
  #' @return A subset of the original spatial map based on the specified CCAA.
...
run_inla <- function(distribution, formula, df_colera, var_col) {
  ...
  if (distribution == "gaussian") { expected_cases <- log(df_colera[[var_col]]) } 
  else if (distribution == "poisson") { expected_cases <- df_colera[[var_col]] }
...
add_results_excel <- function(res_invasiones, res_defunciones, res_table, filename) {
  ...
  addWorksheet(wb, "res_all_invasiones_summary")
  writeData(wb, "res_all_invasiones_summary", res_invasiones$summary.fixed, rowNames = TRUE)
  
  addWorksheet(wb, "res_all_defunciones_summary")
  writeData(wb, "res_all_defunciones_summary", res_defunciones$summary.fixed, rowNames = TRUE)
...
df_colera_ref <- mapS.colera_inla7[, c(PROVINCIA_STR, TOTAL_POBLACION_STR)]
df_colera_ref$geometry <- NULL
df_colera_ref <- df_colera_ref %>% group_by(Provincia) %>% summarize(Total_poblacion_Provincia = sum(Total_poblacion))


# merge df_colera_ref with mapS.colera_inla7

mapS.colera_inla7 <- merge(mapS.colera_inla7, df_colera_ref, by = PROVINCIA_STR)
mapS.colera_inla7 <- mapS.colera_inla7[, c(2:11, 1, 12:18, 28, 19:27, 29)]
head(mapS.colera_inla7)

mapS.colera_inla7$Total_invasiones_Esperadas <- (mapS.colera_inla7$Total_invasiones / mapS.colera_inla7$Total_poblacion_Provincia) * mapS.colera_inla7$Total_poblacion
mapS.colera_inla7$Total_defunciones_Esperadas <- (mapS.colera_inla7$Total_defunciones / mapS.colera_inla7$Total_poblacion_Provincia) * mapS.colera_inla7$Total_poblacion
mapS.colera_inla7 <- mapS.colera_inla7[, c(1:14, 30, 15, 31, 16:29)]
head(mapS.colera_inla7)
...
rm(map_invasiones, map_defunciones, map_tasa.invasiones, map_tasa.defunciones, create_covariatesTS, generate_totalsByMonth, df_colera_inla7, df_colera_ref)


# modelling ---------------------------------------------------------------


# maps by CCAA: "comunitat_valenciana", "aragon", "andalucia" and "murcia"

mapS.colera_inla7.comunitat_valenciana <- mapS_byCCAA(mapS.colera_inla7, c("alicante", "castellon", "valencia"))
mapS.colera_inla7.aragon <- mapS_byCCAA(mapS.colera_inla7, c("huesca", "teruel", "zaragoza"))
mapS.colera_inla7.andalucia <- mapS_byCCAA(mapS.colera_inla7, c("almeria", "cadiz", "cordoba", "granada", "jaen", "malaga"))
mapS.colera_inla7.murcia <- mapS_byCCAA(mapS.colera_inla7, "murcia")
...
# g.list <- list(g, g.comunitat_valenciana, g.aragon, g.andalucia, g.murcia)


# create index vectors by CCAA
...
res_all.invasiones <- run_inla("poisson", formula_all.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
res_all.defunciones <- run_inla("poisson", formula_all.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
res_all.invasiones.comunitat_valenciana <- run_inla("poisson", formula_all.invasiones.comunitat_valenciana, mapS.colera_inla7.comunitat_valenciana, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
res_all.defunciones.comunitat_valenciana <- run_inla("poisson", formula_all.defunciones.comunitat_valenciana, mapS.colera_inla7.comunitat_valenciana, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
res_all.invasiones.aragon <- run_inla("poisson", formula_all.invasiones.aragon, mapS.colera_inla7.aragon, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
res_all.defunciones.aragon <- run_inla("poisson", formula_all.defunciones.aragon, mapS.colera_inla7.aragon, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
res_all.invasiones.andalucia <- run_inla("poisson", formula_all.invasiones.andalucia, mapS.colera_inla7.andalucia, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
res_all.defunciones.andalucia <- run_inla("poisson", formula_all.defunciones.andalucia, mapS.colera_inla7.andalucia, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
res_all.invasiones.murcia <- run_inla("poisson", formula_all.invasiones.murcia, mapS.colera_inla7.murcia, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
res_all.defunciones.murcia <- run_inla("poisson", formula_all.defunciones.murcia, mapS.colera_inla7.murcia, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))

# res_covdist_caprov.invasiones <- run_inla("poisson", formula_covdist_caprov.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_caprov.defunciones <- run_inla("poisson", formula_covdist_caprov.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
# res_covdist_station.invasiones <- run_inla("poisson", formula_covdist_station.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_station.defunciones <- run_inla("poisson", formula_covdist_station.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
# res_covdist_rail.invasiones <- run_inla("poisson", formula_covdist_rail.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_rail.defunciones <- run_inla("poisson", formula_covdist_rail.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
# res_covdist_river.invasiones <- run_inla("poisson", formula_covdist_river.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_river.defunciones <- run_inla("poisson", formula_covdist_river.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
# res_covdist_road.invasiones <- run_inla("poisson", formula_covdist_road.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_road.defunciones <- run_inla("poisson", formula_covdist_road.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
# res_covdist_coast.invasiones <- run_inla("poisson", formula_covdist_coast.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_coast.defunciones <- run_inla("poisson", formula_covdist_coast.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
# res_covdist_port.invasiones <- run_inla("poisson", formula_covdist_port.invasiones, mapS.colera_inla7, paste0(TOTAL_INVASIONES_STR, "_Esperadas"))
# res_covdist_port.defunciones <- run_inla("poisson", formula_covdist_port.defunciones, mapS.colera_inla7, paste0(TOTAL_DEFUNCIONES_STR, "_Esperadas"))
...
res_all.invasiones.list <- list(res_all.invasiones, res_all.invasiones.comunitat_valenciana, res_all.invasiones.aragon, res_all.invasiones.andalucia, res_all.invasiones.murcia)
res_all.defunciones.list <- list(res_all.defunciones, res_all.defunciones.comunitat_valenciana, res_all.defunciones.aragon, res_all.defunciones.andalucia, res_all.defunciones.murcia)
...
# TODO: RR, LL and UL maps


# mapS.colera_inla7$RR_invasiones <- res_all.invasiones$summary.fitted.values[, COEFFICIENTS[1]]
# mapS.colera_inla7$LL_invasiones <- res_all.invasiones$summary.fitted.values[, COEFFICIENTS[2]]
# mapS.colera_inla7$UL_invasiones <- res_all.invasiones$summary.fitted.values[, COEFFICIENTS[3]]
# mapS.colera_inla7$RR_defunciones <- res_all.defunciones$summary.fitted.values[, COEFFICIENTS[1]]
# mapS.colera_inla7$LL_defunciones <- res_all.defunciones$summary.fitted.values[, COEFFICIENTS[2]]
# mapS.colera_inla7$UL_defunciones <- res_all.defunciones$summary.fitted.values[, COEFFICIENTS[3]]
